...
def faster_lucas_kanade_step(I1: np.ndarray,
                             I2: np.ndarray,
                             window_size: int) -> tuple[np.ndarray, np.ndarray]:
    """Faster implementation of a single Lucas-Kanade Step using Harris detector."""
    
    SMALL_IMAGE_THRESHOLD = 2500
    ...
    # Use your Harris detector
    K_HARRIS = 0.05
    TILE_THRESHOLD = 1e8  # you can tune this
    corners_binary = harris_corner_detector.our_harris_corner_detector(I2, K_HARRIS, TILE_THRESHOLD)
    corners = np.argwhere(corners_binary == 1)
